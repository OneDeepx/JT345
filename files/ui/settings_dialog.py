...
class SettingsDialog(QDialog):
    ...
    def test_cryptopanic_connection(self):
        ...
        progress = QProgressDialog("Testing CryptoPanic API connection...", "Cancel", 0, 0, self)
        ...
        try:
            # Test the connection directly WITHOUT saving (to avoid permission issues)
            ...
            if response.status_code == 200:
                ...
                QMessageBox.warning(
                    ...
                    "Try:\n"
                    "• Verify your email on CryptoPanic\n"
